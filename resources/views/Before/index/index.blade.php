...
<title>品优购，优质！优质！</title>
    ...
    <link rel="stylesheet" type="text/css" href="/Before/css/pages-JD-index.css" />
    <link rel="stylesheet" type="text/css" href="/Before/css/widget-jquery.autocomplete.css" />
			...
			<div class="yui3-g SortList ">
				<div class="yui3-u Left all-sort-list">
					<div class="all-sort-list2">
						@foreach($arr as $v)
							<div class="item bo">
								<h3><a href="{{route('before_goods_list',['cat_id'=>$v['id']])}}">{{$v['cat_name']}}</a></h3>
								<div class="item-list clearfix">
									@if(isset($v['two']))
									<div class="subitem">
										@foreach($v['two'] as $k)
											<dl class="fore1">
												<dt><a href="{{route('before_goods_list',['cat_id'=>$k['id']])}}">{{$k['cat_name']}}</a></dt>
												@if(isset($k['three']))
													<dd>
													  @foreach($k['three'] as $b)
													     <a href="{{route('before_goods_list',['cat_id'=>$b['id']])}}">{{$b['cat_name']}}</a></em>
													  @endforeach
													</dd>
												@endif
											</dl>					
					...
					<div id="myCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
					  ...
					  <div class="carousel-inner">
					    ...
					    <a href="http://baidu2.wypxj.com/">
					    	<img src="/Before/img/banner1.jpg"  />
					      </a>
					    </div>
					    <div class="item">
						 <a href="http://baidu2.wypxj.com/">
						<img src="/Before/img/banner2.jpg"  />
					     </a>
					    </div>
					    <div class="item">
						 <a href="http://baidu2.wypxj.com/">
						<img src="/Before/img/banner3.jpg"  />
						</a>
		...
		<div class="py-container">
			<ul class="yui3-g Recommend">
				<li class="yui3-u-1-6  clock">
					<div class="time">
						<img src="/Before/img/clock.png" />
						<h3>今日推荐</h3>
					</div>
				</li>
				<li class="yui3-u-5-24">
					<a href="list.html" target="_blank"><img src="/Before/img/today01.png" /></a>
				</li>
				<li class="yui3-u-5-24">
					<img src="/Before/img/today02.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="/Before/img/today03.png" />
				</li>
				<li class="yui3-u-5-24">
					<img src="/Before/img/today04.png" />
				</li>
			</ul>
		</div>
	</div>
				...
				<ul class="clearfix yui3-g Favourate picLB" id="picLBxxl">
					<li class="yui3-u-1-6">
						<dl class="picDl huozhe">
							<dd>
								<a href="" class="pic"><img src="/Before/img/like_02.png" alt="" /></a>
								<div class="like-text">
							...
							<dd>
								<a href="" class="pic"><img src="/Before/img/like_01.png" alt="" /></a>
								<div class="like-text">
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="" class="pic"><img src="/Before/img/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>爱仕达 30CM炒锅不粘锅NWG8330E电磁炉炒</p>
									<h3>¥116.00</h3>
								</div>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl jilu">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/Before/img/like_03.png" alt="" /></a>
								<div class="like-text">
									<p>捷波朗 </p>
									<p>（jabra）BOOSI劲步</p>
									<h3>¥236.00</h3>
							...
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/Before/img/like_02.png" alt="" /></a>
								<div class="like-text">
									<p>欧普</p>
									<p>JYLZ08面板灯平板灯铝</p>
									<h3>¥456.00</h3>
					...
					<li class="yui3-u-1-6">
						<dl class="picDl tuhua">
							<dd>
								<a href="http://sc.chinaz.com/" class="pic"><img src="/Before/img/like_01.png" alt="" /></a>
								<div class="like-text">
									<p>三星（G5500）</p>
									<p>移动联通双网通</p>
									<h3>¥566.00</h3>
		...
		<div class="py-container">
			...
			<div class="clearfix yui3-g Interest">
				...
				<div class="yui3-u row-405 Interest-conver">
					<img src="/Before/img/interest01.png" />
				</div>
				<div class="yui3-u row-225 Interest-conver-split">
					<h5>好东西</h5>
					<img src="/Before/img/interest02.png" />
					<img src="/Before/img/interest03.png" />
				</div>
				<div class="yui3-u row-405 Interest-conver-split blockgary">
					<h5>品牌街</h5>
					<div class="split-bt">
						<img src="/Before/img/interest04.png" />
					</div>
					<div class="x-img fl">
						<img src="/Before/img/interest05.png" />
					</div>
					<div class="x-img fr">
						<img src="/Before/img/interest06.png" />
					</div>
				</div>
				<div class="yui3-u row-165 brandArea">
					<span class="brand-yline"></span>
					<ul class="yui3-g brand-list">
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand01.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand02.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand03.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand04.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand05.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand06.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand07.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand08.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand09.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand10.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand11.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand12.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand13.png" /></li>
						<li class="yui3-u-1-2 brand-pit"><img src="/Before/img/brand03.png" /></li>
					</ul>
				</div>
			</div>
				...
				<div id="tab1" class="tab-pane active">
					<div class="yui3-g Floor-1">
						<div class="yui3-u Left blockgary">
							...
							<img src="/Before/img/floor-1-1.png" />
						</div>
						<div class="yui3-u row-330 floorBanner">
							<div id="floorCarousel" data-ride="carousel" data-interval="4000" class="sui-carousel slide">
								...
								<div class="carousel-inner">
									<div class="active item">
										<img src="/Before/img/floor-1-b01.png">
									</div>
									<div class="item">
										<img src="/Before/img/floor-1-b02.png">
									</div>
									<div class="item">
										<img src="/Before/img/floor-1-b03.png">
									</div>
								</div>
						...
						<div class="yui3-u row-220 split">
							...
							<div class="floor-conver-pit">
								<img src="/Before/img/floor-1-2.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="/Before/img/floor-1-3.png" />
							</div>
						</div>
						<div class="yui3-u row-218 split">
							<img src="/Before/img/floor-1-4.png" />
						</div>
						<div class="yui3-u row-220 split">
							<span class="floor-x-line"></span>
							<div class="floor-conver-pit">
								<img src="/Before/img/floor-1-5.png" />
							</div>
							<div class="floor-conver-pit">
								<img src="/Before/img/floor-1-6.png" />
							</div>
						</div>
					</div>
				</div>
	...
	<div class="brand">
		<div class="py-container">
			<ul class="Brand-list blockgary">
				<li class="Brand-item">
					<img src="/Before/img/brand_21.png" />
				</li>
				<li class="Brand-item"><img src="/Before/img/brand_03.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_05.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_07.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_09.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_11.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_13.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_15.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_17.png" /></li>
				<li class="Brand-item"><img src="/Before/img/brand_19.png" /></li>
			</ul>
		</div>
	</div>
	@endsection
...
<script type="text/javascript" src="/Before/js/pages/index.js"></script>
<script type="text/javascript" src="/Before/js/widget/cartPanelView.js"></script>
<script type="text/javascript" src="/Before/js/widget/jquery.autocomplete.js"></script>
<script type="text/javascript" src="/Before/js/widget/nav.js"></script>
@endsection