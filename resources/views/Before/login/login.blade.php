...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/Before/css/pages-login.css" />
</head>
	...
	<div class="login-box">
		...
		<div class="loginArea">
				...
				<div class="loginform">
					...
					<div class="tab-content tab-wraped">
						...
						<div id="profile" class="tab-pane  active">
							<form action="{{route('user_dologin')}}" method="post" class="sui-form">
							{{csrf_field()}}
							<div class="input-prepend"><span class="add-on loginname"></span>
									<input id="prependedInput" name="zhaohao" type="text" placeholder="用户名/手机号" class="span2 input-xfat">
								</div>
          ...
          自动登录
								...
								<div class="logined">
								<button src="submit" class="sui-btn btn-block btn-xlarge btn-danger">登&nbsp;&nbsp;录</button>
							...
							<div class="otherlogin">
								...
								<span class="register"><a href="{{route('user_register')}}" target="_blank">立即注册</a></span>
							</div>
						</div>
					</div>
				</div>
...
<script type="text/javascript" src="/Before/js/pages/login.js"></script>
</body>
