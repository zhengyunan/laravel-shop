...
@section('content')
    ...
    <link rel="stylesheet" type="text/css" href="/Before/css/pages-item.css" />
    <link rel="stylesheet" type="text/css" href="/Before/css/pages-zoom.css" />
					...
					<div class="fl preview-wrap">
						...
						<div class="zoom">
							...
							<div id="preview" class="spec-preview">
								<span class="jqzoom"><img jqimg="{{$goodsidall['sku'][0]['img']['0']['bigimg_path']}}" src="{{$goodsidall['sku'][0]['img']['0']['smallimg_path']}}" /></span>
							</div>
							<!--下方的缩略图-->
							<div class="spec-scroll">
								...
								<div class="items">
									<ul>
									 @foreach($goodsidall['sku'] as $v)
									   
										 @foreach($v['img'] as $g) 
									
										    <li><img src="{{$g['smallimg_path']}}" bimg="{{$g['bigimg_path']}}" onmousemove="preview(this)" /></li>
									    @endforeach
						...
						<div class="summary">
							...
							<div class="summary-wrap">
								...
								<div class="fl fix-width">
									...
									<em class="t-gray">{{$goodsidall['content']}}</em>
								</div>
							</div>
						</div>
						<div class="support">
						...
						<div class="clearfix choose">
							...
							@foreach($goodsidall['key'] as $d=>$v)
								<dl>
									...
									@foreach($v['val'] as $k=>$b)
									<dd><a href="javascript:;" class="choose1" data-attrkey="{{$d}}">{{$b['attr_val']}}<span title="点击取消选择">&nbsp;</span></a></dd>	
									@endforeach
								</dl>
								@endforeach
							</div>
...
<script type="text/template" id="tbar-cart-item-template">
	<div class="tbar-cart-item" >
		...
		<div class="jtc-item-goods">
			<span class="p-img"><a href="#" target="_blank"><img src="" alt="" height="50" width="50" /></a></span>
			<div class="p-name">
				<a href="#"></a>
			</div>
...
<script type="text/javascript" src="/Before/js/plugins/jquery.jqzoom/jquery.jqzoom.js"></script>
<script type="text/javascript" src="/Before/js/plugins/jquery.jqzoom/zoom.js"></script>


<!--页面底部  结束 -->
<script>
	var getAbc=document.querySelectorAll(".choose1");
	// console.log(getAbc);
