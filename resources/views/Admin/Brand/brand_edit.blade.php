...
<html>
    ...
    <body> 
        <div class="x-body" >
            <form action="{{route('brand_update',['id'=>$brand->id])}}" class="layui-form" method="post"  enctype="multipart/form-data">
               {{csrf_field()}} 
                <div class="layui-form-item">
                    <label  class="layui-form-label">品牌LOGO
                    </label>
                    <input type="file" name="logo">
                    <img id="LAY_demo_upload" width="400" Height="200" src="{{$brand->logo}}">
                </div>
                <div class="layui-form-item">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="{{$brand->attribution}}">
                    </div>
                </div>
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        ...
                        autocomplete="off" class="layui-input" value="{{$brand->describe}}">
                    </div>
