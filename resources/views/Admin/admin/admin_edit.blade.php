...
<html>
    ...
    <body>
        <div class="x-body">
            <form class="layui-form" action="{{route('admin_update',['id'=>$data->admin_id])}}" method="post">
                {{csrf_field()}}
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="username" name="admin_name" required="" lay-verify="required" value="{{$data->admin_name}}" 
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="phone" value="{{$data->tel}}" name="tel" required="" lay-verify="phone"
                        autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-form-mid layui-word-aux">
                        <span class="x-red">*</span>将会成为您唯一的登入名
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="password" id="L_pass" name="admin_password" required="" lay-verify="pass"
