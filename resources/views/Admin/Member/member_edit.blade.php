...
<html>
    ...
    <body>
        <div class="x-body">
            <form action="{{route('member_update',['id'=>$user->id])}}" method="post" class="layui-form">
                {{csrf_field()}}
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-inline">
                        <div class="layui-input-inline">
                            ...
                            @else
                                <input type="radio" name="sex" checked value="1" title="女">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <input type="text" id="L_city" name="attribution" autocomplete="off" value="{{$user->attribution}}"
                        class="layui-input">
                    </div>
                </div>
                <div class="layui-form-item layui-form-text">
                    ...
                    <div class="layui-input-block">
                        ...
                        class="layui-textarea" style="height: 80px;">{{$user->signature}}</textarea>
                    </div>
                </div>
                <div class="layui-form-item">
                    <label for="L_sign" class="layui-form-label">
                    </label>
                    <button type="submit" class="layui-btn" key="set-mine"  lay-submit>
                        保存
                    </button>
                </div>
            </form>
