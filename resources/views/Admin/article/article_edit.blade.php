...
<html>
    ...
    <body>
        <div class="x-body">
            <form action="{{route('article_update',['id'=>$article->id])}}" method="post" class="layui-form layui-form-pane">
              {{csrf_field()}}    
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                        <div class="layui-input-inline">
                           @if($article->is_show=='y')
                                 <input type="radio" name="sex" value="y" checked title="可见">
                                 <input type="radio" name="sex" value="n" title="不可见">
                            @else
                                <input type="radio" name="sex" value="y" title="可见"> 
                                <input type="radio" name="sex" checked value="n" title="不可见">
                            @endif
                        </div>
                    </div>
