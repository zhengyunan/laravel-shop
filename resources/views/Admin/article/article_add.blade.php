...
<html>
    ...
    <body>
        <div class="x-body">
            <form action="{{route('article_doadd')}}" method="post" class="layui-form layui-form-pane">
              {{csrf_field()}}    
            <div class="layui-form-item">
                ...
                <div class="layui-inline">
                        <div class="layui-input-inline">
                                ...
                                <input type="radio" name="sex" checked value="y" title="可见">
                ...
                <div class="layui-form-item">
                    <div class="layui-inline">
                        ...
                        <div class="layui-input-block">
                            <select name=cat_id lay-verify="required" name="cid">
