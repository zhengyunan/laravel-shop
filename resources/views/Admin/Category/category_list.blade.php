...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form x-center" method="post" action="{{route('category_add')}}" style="width:50%">
                {{csrf_field()}} 
                <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline" style="width:80px">
                        <button type="submit" class="layui-btn"  lay-submit=""><i class="layui-icon">&#xe608;</i>增加</button>
                    </div>
                  </div>
                </div> 
            </form>
            ...
            <table class="layui-table">
                ...
                <tbody id="x-link">
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="{{route('category_edit',['id'=>$v->id])}}" class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            
                            <a title="删除" href="{{route('category_delete',['id'=>$v->id])}}" onclick="cate_del(this,'1')" 
                            style="text-decoration:none">
                                <i class="layui-icon">&#xe640;</i>
                            </a>

                            <a title="添加属性" href="" class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">添加属性</i>
                            </a>
                        </td>
                    </tr>
                    @endforeach
