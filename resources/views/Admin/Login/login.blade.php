    ...
    <body style="background-color: #393D49">
        <div class="x-box">
            ...
            <div class="x-mid">
                ...
                <div class="input">
                <form action="{{route('dologin')}}" method="POST" class="">
                    {{csrf_field()}}
                        <div class="layui-form-item x-login-box">
                            ...
                            <div class="layui-input-inline">
                                <input type="text" id="admin_name" name="admin_name" required="" lay-verify="admin_name"
                                autocomplete="off" placeholder="admin_name" class="layui-input">
                            </div>
                        </div>
                        <div class="layui-form-item x-login-box">
                            ...
                            <div class="layui-input-inline">
                                <input type="password" id="admin_password" name="admin_password" required="" lay-verify="admin_password"
