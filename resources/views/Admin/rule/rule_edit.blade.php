...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form x-center" action="{{route('rule_update',['id'=>$data->id])}}" method="post" style="width:70%">
              {{csrf_field()}}    
            <div class="layui-form-pane" style="margin-top: 15px;">
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                      <input type="text" name="url_path"  placeholder="模块/控制器/方法" autocomplete="off" class="layui-input" value="{{$data->url_path}}">
                    </div>
                    <div class="layui-input-inline">
                      <input type="text" name="rule_name"  placeholder="权限名称" autocomplete="off" class="layui-input" value="{{$data->rule_name}}">
                    </div>
                    <div class="layui-input-inline" style="width:80px">
                        <button class="layui-btn" type="submit"  lay-submit=""><i class="layui-icon">&#xe608;</i>修改</button>
                    </div>
                  </div>
                </div> 
            </form>
