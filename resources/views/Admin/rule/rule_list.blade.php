...
<html>
    ...
    <body>
        ...
        <div class="x-body">
            <form class="layui-form x-center" action="{{route('rule_doadd')}}" method="post" style="width:70%">
              {{csrf_field()}}    
                  ...
                  <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select name="cat_id">
                            ...
                            @foreach($rulecat as $k)
                              <option value="{{$k->id}}">{{$k->cat_name}}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="layui-input-inline">
                    ...
                    <div class="layui-input-inline">
                      <input type="text" name="rule_name"  placeholder="权限名称" autocomplete="off" class="layui-input">
                    </div>
                    <div class="layui-input-inline" style="width:80px">
                        <button class="layui-btn" type="submit"  lay-submit=""><i class="layui-icon">&#xe608;</i>添加</button>
                    </div>
                  </div>
                </div> 
            </form>
            ...
            <table class="layui-table">
                ...
                <tbody id="x-link">
                    ...
                    <tr>
                        ...
                        <td class="td-manage">
                            <a title="编辑" href="{{route('rule_edit',['id'=>$v->id])}}" 
                            class="ml-5" style="text-decoration:none">
                                <i class="layui-icon">&#xe642;</i>
                            </a>
                            <a title="删除" href="{{route('rule_delete',['id'=>$v->id])}}" 
