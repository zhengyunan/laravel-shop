                    ...
                    <ul class="layui-nav layui-nav-tree site-demo-nav" lay-filter="side">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="{{route('goods_list')}}">
                                            <cite>产品列表</cite>
                                        </a>
                                    </dd>
                                </dd>
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="{{route('brand_list')}}">
                                            <cite>品牌管理</cite>
                                        </a>
                                    </dd>
                                </dd>
                                <dd class="">
                                    <dd class="">
                                        <a href="javascript:;" _href="{{route('category_list')}}">
                                            <cite>产品分类</cite>
                                        </a>
                                    </dd>
                                </dd>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('article_list')}}">
                                        <cite>文章列表</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('articat_list')}}">
                                        <cite>文章分类管理</cite>
                                    </a>
                                </dd>
                            </dl>
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('member_list')}}">
                                        <cite>会员列表</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                ...
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('level_create')}}">
                                        <cite>等级管理</cite>
                                    </a>
                                </dd>
                                <dd class="">
                        ...
                        <li class="layui-nav-item">
                            ...
                            <dl class="layui-nav-child">
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('Admin_list')}}">
                                        <cite>管理员列表</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('role_list')}}">
                                        <cite>角色管理</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('rulecat_list')}}">
                                        <cite>权限分类</cite>
                                    </a>
                                </dd>
                                <dd class="">
                                    <a href="javascript:;" _href="{{route('rule_list')}}">
                                        <cite>权限管理</cite>
                                    </a>
                                </dd>
                            </dl>
